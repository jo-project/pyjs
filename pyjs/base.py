'''Most important file in pyjs implementation: PyJs class - father of all PyJs objects'''
...
import pyjsparser
pyjsparser.parser.ENABLE_pyjs_ERRORS = lambda msg: MakeError('SyntaxError', msg)
